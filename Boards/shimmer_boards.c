...
uint8_t ShimBrd_isBmp581PresentPerSrNumber(void)
{
   ...
   * and the PCB rev index (docs/SHIMMER3_BOARD_REVISIONS.md) the fitted
   * models are (>= applies to both rev fields):
   *   SR31-11-2, SR38-4-2, SR47-8-2, SR48-7-2, SR48-8-2, SR49-4-2
  ...
  return (ShimBrd_isHwId(HW_ID_SHIMMER3R)
      && (ShimBrd_isBoardSrNumberGte(SHIMMER3_IMU, 11, 2)
          || ShimBrd_isBoardSrNumberGte(EXP_BRD_PROTO3_DELUXE, 4, 2)
