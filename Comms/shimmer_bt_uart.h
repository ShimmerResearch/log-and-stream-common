...
enum
{
  ...
  BT_STREAM_CMD_STATE_START_BT = 1,
  BT_STREAM_CMD_STATE_START_HW = 2,
  BT_STREAM_CMD_STATE_START_OTH = 3,
  BT_STREAM_CMD_STATE_STOP_BT = 4,
  BT_STREAM_CMD_STATE_STOP_HW = 5,
  BT_STREAM_CMD_STATE_STOP_OTH = 6
};

enum
{
  SD_LOG_CMD_STATE_IDLE = 0,
  SD_LOG_CMD_STATE_START_BT = 1,
  SD_LOG_CMD_STATE_START_HW = 2,
  SD_LOG_CMD_STATE_START_OTH = 3,
  SD_LOG_CMD_STATE_STOP_BT = 4,
...
enum
{
  SD_BT_LOG_STREM_CMD_SRC_NONE = 0,
  SD_BT_LOG_STREAM_CMD_SRC_BT = 1,
  SD_BT_LOG_STREAM_CMD_SRC_HW = 2,
  SD_BT_LOG_STREAM_CMD_SRC_OTH = 3
};
