...
//TODO move to test option from BT/UART command. Blocking off currently because Shimmer3 doesn't support printing to UART and HAL_Delay.
#if defined(SHIMMER3R)
/**
...
void ShimLeds_testOperationalStates(void)
{
  ...
  uint8_t rwcErrorFlashBckup = rwcErrorFlash;

  SHIMMER_PRINTF("\r\nTesting Operational LED states - Start\r\n");

  SHIMMER_PRINTF("BT Disabled:\r\n");
  SHIMMER_PRINTF("\t-> Idle...\r\n");
  ...
  SHIMMER_PRINTF("\t-> SD Logging...\r\n");
  shimmerStatus.sensing = 1;
  shimmerStatus.sdLogging = 1;
  HAL_Delay(5000);

  SHIMMER_PRINTF("BT Enabled:\r\n");
  SHIMMER_PRINTF("\t-> Idle...\r\n");
  shimmerStatus.sensing = 0;
  ...
  SHIMMER_PRINTF("\t-> BT Streaming and SD Logging...\r\n");
  shimmerStatus.sensing = 1;
  shimmerStatus.sdLogging = 1;
  shimmerStatus.btStreaming = 1;
  shimmerStatus.btConnected = 1;
  ...
  SHIMMER_PRINTF("\t-> BT Connected and SD Logging...\r\n");
  shimmerStatus.sensing = 1;
  shimmerStatus.sdLogging = 1;
  shimmerStatus.btStreaming = 0;
  shimmerStatus.btConnected = 1;
  ...
  SHIMMER_PRINTF("SD Sync Enabled:\r\n");
  ...
  SHIMMER_PRINTF("\t-> SD Logging waiting for initial sync (slave)...\r\n");
  shimmerStatus.sensing = 1;
  shimmerStatus.sdLogging = 1;
  shimmerStatus.btPowerOn = 1;
  shimmerStatus.btIsInitialised = 1;
  ...
  SHIMMER_PRINTF("\t-> SD Logging waiting for initial sync (master)...\r\n");
  shimmerStatus.sensing = 1;
  shimmerStatus.sdLogging = 1;
  shimmerStatus.btPowerOn = 1;
  shimmerStatus.btIsInitialised = 1;
  ...
  SHIMMER_PRINTF("\t-> SD Logging and BT advertising...\r\n");
  shimmerStatus.sensing = 1;
  shimmerStatus.sdLogging = 1;
  shimmerStatus.btPowerOn = 1;
  shimmerStatus.btIsInitialised = 1;
  ...
  SHIMMER_PRINTF("\t-> SD Logging and syncing...\r\n");
  shimmerStatus.sensing = 1;
  shimmerStatus.sdLogging = 1;
  shimmerStatus.btPowerOn = 1;
  shimmerStatus.btIsInitialised = 1;
  ...
  SHIMMER_PRINTF("\t-> Configuring...\r\n");
  shimmerStatus.configuring = 1;
  HAL_Delay(5000);
  shimmerStatus.configuring = 0;

  SHIMMER_PRINTF("\t-> Time not set...\r\n");
  ...
  SHIMMER_PRINTF("Testing Operational LED states - End\r\n");
}
#endif
